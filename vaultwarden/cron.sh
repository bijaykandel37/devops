...
HTTP_CODE=$(curl --silent -H 'Content-Type: application/json' -X POST https://chat.googleapis.com/v1/spaces/AAf/messages\?key\=AISyHI\&token\=K_iTwxomXo%9D --data '{"text": "`Vault Backup Completed`✅"}')
